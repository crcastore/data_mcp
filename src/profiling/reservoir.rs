...
mod tests {
    ...
    fn logistic_map(n: usize) -> Vec<f64> {
    ...
    fn test_surrogate_logistic_detects_nonlinearity() {
        let vals = logistic_map(1000);
        let result = surrogate_test(&vals, 100).unwrap();
    ...
    fn test_bds_logistic() {
        let vals = logistic_map(500);
        let result = bds_test(&vals, 3, 0.5).unwrap();
        assert!(result.p_value < 0.05);
    }

    #[test]
    fn test_bds_returns_valid() {
        let vals = linear_series(500);
        let result = bds_test(&vals, 2, 0.05).unwrap();
    ...
    fn test_lyapunov_logistic_positive() {
        let vals = logistic_map(2000);
        let l = lyapunov_exponent(&vals, 3, 1).unwrap();
    ...
    fn test_dependence_comparison_lengths() {
        let vals = logistic_map(1000);
        let result = dependence_comparison(&vals, 10).unwrap();
    ...
    fn test_dependence_mi_positive() {
        let vals = logistic_map(1000);
        let result = dependence_comparison(&vals, 5).unwrap();
    ...
    fn test_delay_embedding_sine() {
        let vals = sine_wave(500);
        let result = delay_embedding(&vals, 10).unwrap();
    ...
    fn test_memory_profile_ar() {
        let vals = linear_series(1000);
        let result = memory_profile(&vals, 10).unwrap();
